    ...
    public sealed class EmmetPackage : AsyncPackage
    {
        ...
        internal bool RunCommand(ViewContext context, int cmdId)
        {
            ...
            try
            {
                ...
                bool succeeded = _engine.RunCommand(cmdId, context, Options.AutoFormatCode);

                if (ownUndoContext)
                    dte.UndoContext.Close();

                Trace("Emmet command succeeded");
            ...
            IProgress<ServiceProgressData> progress)
        {
            ...
            if (File.Exists(Options.PreferencesFile))
                _engine = new EngineWrapper(Options.PreferencesFile);
            else
            ...
            if (Options.WriteDebugMessages)
            {
                ...
                Trace("Emmet package initialized");
            }
        }
