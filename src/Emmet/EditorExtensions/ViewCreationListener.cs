...
namespace Emmet.EditorExtensions
{
    ...
    public class ViewCreationListener : IVsTextViewCreationListener
    {
        ...
        public void VsTextViewCreated(IVsTextView textViewAdapter)
        {
            ...
            Trace($"Attached to view of type {contentType}");

            // As of version 2026 Visual Studio does not use projection buffer for JSX files and thus we
            // cannot detect JS and HTML buffers. So, in order to prevent unintended JS and Emmet snippets
            // collisions we require prefix for emmet abbreviations to work correctly.
            if (contentType.EndsWith("react", StringComparison.InvariantCultureIgnoreCase))
