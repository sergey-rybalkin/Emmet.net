...
{
    /// <summary>
    /// Values that represent Chakra error codes.
    /// </summary>
    public enum JavaScriptErrorCode
    {
        ...
        /// <summary>
        /// A bad serialized script was used, or the serialized script was serialized by a different version
        /// of the Chakra engine.
        /// </summary>
        BadSerializedScript,
        ...
        /// <summary>
        ///  script was terminated due to a request to suspend a runtime.
        /// </summary>
        ScriptTerminated,

        /// <summary>
        ///  script was terminated because it tried to use <c>eval</c> or <c>function</c> and eval was
        ///  disabled.
        /// </summary>
        ScriptEvalDisabled,
